...
namespace ClearVRAM {
    public static class BuildInfo {
        ...
        public const string Author = "Requi / pp021 edit";
    ...
    public class ClearVRAM : MelonMod {
        public override void OnApplicationStart() {
            ExpansionKitApi.GetExpandedMenu(ExpandedMenu.QuickMenu).AddSimpleButton("Clear VRAM", () => {
                var currentAvatars = (from player in PlayerManager.field_Private_Static_PlayerManager_0.prop_ArrayOf_Player_0 where player != null select player.prop_ApiAvatar_0 into apiAvatar where apiAvatar != null select apiAvatar.assetUrl).ToList();
